...
int electro_eic_D_condor(int Nsim, int Ntotalbatch, int Nbatch, double Ebeam, double Hbeam, 
  ...
  // TTree Info
  TFile * fall2 = new TFile(Form("D-%d-%d_%.0fx%.0f_Y_%.2f_%.2f_Q2_%.2f_%.2f/run%d.root",Nsim,Ntotalbatch,Ebeam,Hbeam,ymin,ymax,Q2min,Q2max,Nbatch),"RECREATE");
