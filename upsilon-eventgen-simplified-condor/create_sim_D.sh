...
CURRENT_DIR="/sphenix/user/gregtom3/Duke/VM_Subthreshold/upsilon-eventgen-simplified-condor"
...
#-----------------------------------
TITLE="D-${NEVENTS}-${NBATCHES}_${ELECTRON_ENERGY}x${HADRON_ENERGY}_Y_${YMIN}_${YMAX}_Q2_${Q2MIN}_${Q2MAX}"
...
echo "root -l electro_eic_D_condor.C\\(${NEVENTS},${NBATCHES},\$1,${ELECTRON_ENERGY},${HADRON_ENERGY},${YMIN},${YMAX},${Q2MIN},${Q2MAX}\\)" >> $SARTRE_SH
