...
int main(const int argc, const char * argv[]){
  ...
  // detected 1
  TFile * fall1 = new TFile("result-photo-jpsi/Dsolid1.root", "RECREATE");
  ...
  TFile * fsub1 = new TFile("result-photo-jpsi/Dsolidsub1.root", "RECREATE");
  ...
  // TTree Info
  TFile * fall2 = new TFile("result-photo-jpsi/Dsolid.root", "RECREATE");
