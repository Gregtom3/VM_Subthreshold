...
int electro_eic_study_P_Y1S(){
  ...
  // TTree Info
  TFile * fall2 = new TFile(Form("result-eic-P-Y1S/eic_electro_%.1fGeV_%.1fGeV_y_%.2f_%.2f_Q2_%.2f_%.2f.root",Ebeam,Hbeam,ymin,ymax,Q2min,Q2max), "RECREATE");
  ...
  TH1F *h_W_1 = new TH1F("h_W_1","Upsilon Electroproduction at EIC (e+p);|t| [GeV^{2}];d#sigma/dt [nb/GeV^{2}]",nbins_t,-tmax,-tmin);
  TH1F *h_W_2 = new TH1F("h_W_2","Upsilon Electroproduction at EIC (e+p);|t| [GeV^{2}];d#sigma/dt [nb/GeV^{2}]",nbins_t,-tmax,-tmin);
  TH1F *h_W_3 = new TH1F("h_W_3","Upsilon Electroproduction at EIC (e+p);|t| [GeV^{2}];d#sigma/dt [nb/GeV^{2}]",nbins_t,-tmax,-tmin);
  TH1F *h_W_4 = new TH1F("h_W_4","Upsilon Electroproduction at EIC (e+p);|t| [GeV^{2}];d#sigma/dt [nb/GeV^{2}]",nbins_t,-tmax,-tmin);
  TH1F *h_W_5 = new TH1F("h_W_5","Upsilon Electroproduction at EIC (e+p);|t| [GeV^{2}];d#sigma/dt [nb/GeV^{2}]",nbins_t,-tmax,-tmin);
  TH1F *h_W_6 = new TH1F("h_W_6","Upsilon Electroproduction at EIC (e+p);|t| [GeV^{2}];d#sigma/dt [nb/GeV^{2}]",nbins_t,-tmax,-tmin);
  TH1F *h_W_7 = new TH1F("h_W_7","Upsilon Electroproduction at EIC (e+p);|t| [GeV^{2}];d#sigma/dt [nb/GeV^{2}]",nbins_t,-tmax,-tmin);
  TH1F *h_W_8 = new TH1F("h_W_8","Upsilon Electroproduction at EIC (e+p);|t| [GeV^{2}];d#sigma/dt [nb/GeV^{2}]",nbins_t,-tmax,-tmin);
  TH1F *h_W_9 = new TH1F("h_W_9","Upsilon Electroproduction at EIC (e+p);|t| [GeV^{2}];d#sigma/dt [nb/GeV^{2}]",nbins_t,-tmax,-tmin);
  TH1F *h_W_10 = new TH1F("h_W_10","Upsilon Electroproduction at EIC (e+p);|t| [GeV^{2}];d#sigma/dt [nb/GeV^{2}]",nbins_t,-tmax,-tmin);
