int plot_nevents_vs_Egamma()
{
  ...
  latex.DrawLatexNDC(0.15,0.9,Form("e+%s #rightarrow e'+p'+#psi(2S) (e^{-}e^{+}) , Photoprodution",stringA.Data()));
  ...
  latex.DrawLatexNDC(0.1,0.9,Form("e+%s #rightarrow e'+p'+#psi(2S) (e^{-}e^{+}) , Electroprodution",stringA.Data()));
  ...
  latex.DrawLatexNDC(0.1,0.95,Form("#bf{SoLID} Simulation (%.1f GeV beam)",eIn_E));
  latex.DrawLatexNDC(0.1,0.9,Form("e+%s #rightarrow e'+p'+#psi(2S) (e^{-}e^{+}) , Photo+electro prodution",stringA.Data()));
